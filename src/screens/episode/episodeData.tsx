export const EpisodeData = {
  ...
  description: (
    <div>
      The Popcast is hosted by Jon Caramanica, a pop music critic for The New
      York Times. It covers the latest in popular music criticism, trends and
      news.
      <div>
        <br />
        This episode is sponsored by <a href="#!">Vynil me please</a>,{" "}
        <a href="#!">Tumtable lab</a>, and <a href="#!">lynda.com</a>
      </div>
    </div>
  ),
};
